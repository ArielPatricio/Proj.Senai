//Contéudo contendo a lógica para consumir a API labschool
...
function createAluno(){
    ...
    axios.post(`${url}/aluno`, data).then((response) => {
        ...
        window.location.href = "http://127.0.0.1:5500/users/formsCreate.html"
...
function redirect(codigo, nome, telefone, data, endereco){
    window.location.href = `http://127.0.0.1:5500/users/formsUpdate.html?codigo=${codigo}&nome=${nome}&telefone=${telefone}&data=${data}&endereco=${endereco}`
...
//Split: remover da String o caractere '/' e retorna um array com os demais caracteres 
